...
namespace AnvizDemo
{
    class Anviz
    {
        ...
        public enum MODE_FP_Type : int
        {
            ...
            DEV_TYPE_FLAG_FP_LEN_1200 = 0x2000,  //IRIS2000设备
...
************************************/
        ...
        ************************************/
        ...
        [DllImport("tc-b_new_sdk.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int CChex_UploadGetFacePictureModule(IntPtr CchexHandle, int DevIdx, ref CCHEX_DEL_PERSON_INFO_STRU Param, byte[] PictureBuff, int BuffLen);
